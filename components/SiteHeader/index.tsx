...
const SiteHeader = ({ compare }: Iprops) => {
  return (
      ...
      <nav className='sm:flex sm:items-center sm:px-4 xl:flex-1 xl:justify-end hidden'>
        <div className='sm:flex sm:items-center'>
          <div className='px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-b-0 sm:py-0 sm:px-0'>
            <span
              onClick={compare}
              className='flex items-center justify-center text-lg blue-grey-800 mr-10'
            >
              <svg
                width='16'
                height='16'
            ...
            <span className='flex items-center justify-center text-lg blue-grey-800 mr-10'>
              ...
              >
                <path
                  d='M7 16.0001C7.53043 16.0001 8.03914 15.7893 8.41422 15.4143C8.78929 15.0392 9 14.5305 9 14.0001H5C5 14.5305 5.21071 15.0392 5.58578 15.4143C5.96086 15.7893 6.46957 16.0001 7 16.0001Z'
                  fill='#607D8B'
                />
                <path
                  d='M12.25 10.6371V6.70011C12.2974 5.53643 11.9262 4.39428 11.2037 3.48081C10.4812 2.56734 9.45531 1.94303 8.312 1.72111V1.18211C8.27732 0.858206 8.1241 0.558561 7.88181 0.340821C7.63951 0.123081 7.32526 0.00262451 6.9995 0.00262451C6.67374 0.00262451 6.35949 0.123081 6.1172 0.340821C5.8749 0.558561 5.72168 0.858206 5.687 1.18211V1.71711C4.54326 1.93953 3.51714 2.56456 2.7948 3.47881C2.07247 4.39306 1.70178 5.53594 1.75 6.70011V10.6391L0 12.2151V13.0001H14V12.2121L12.25 10.6371ZM10.5 11.4251H3.5V6.70011C3.5 5.77185 3.86875 4.88162 4.52513 4.22524C5.1815 3.56886 6.07174 3.20011 7 3.20011C7.92826 3.20011 8.81849 3.56886 9.47487 4.22524C10.1313 4.88162 10.5 5.77185 10.5 6.70011V11.4251Z'
                  fill='#607D8B'
                />
